...
function ChooseLanguage({ navigation }) {
    ...
    return (
        <ScrollView style={[styles.container, themeContainerStyle]}>
            <View style={[styles.panel, themeContainerSelectStyle]}>
                <Text style={[styles.title, themeSubTextStyle]} >Выбрать язык</Text>
                <View style={styles.inline}>
                    <View style={styles.row}>
                        {/* <Image source={require('../../assets/images/Profile/Visa.png')} style={{ marginRight: 10 }} /> */}
                        <Text style={[styles.text, themeTextStyle]} >Русский</Text>
                    </View>
                    <BouncyCheckbox
                        size={24}
                        fillColor='#F5CB57'
                ...
                <View style={styles.inline}>
                    <View style={styles.row}>
                        ...
                        <Text style={[styles.text, themeTextStyle]} >中文</Text>
                    </View>
                    <BouncyCheckbox
                        size={24}
                        fillColor='#F5CB57'
                ...
                <View style={styles.inline}>
                    <View style={styles.row}>
                        {/* <Image source={require('../../assets/images/Profile/Visa.png')} style={{ marginRight: 10 }} /> */}
                        <Text style={[styles.text, themeTextStyle]} >English</Text>
                    </View>
                    <BouncyCheckbox
                        size={24}
                        fillColor='#F5CB57'
                ...
                <View style={styles.inline}>
                    <View style={styles.row}>
                        {/* <Image source={require('../../assets/images/Profile/Visa.png')} style={{ marginRight: 10 }} /> */}
                        <Text style={[styles.text, themeTextStyle]} >Español</Text>
                    </View>
                    <BouncyCheckbox
                        size={24}
                        fillColor='#F5CB57'

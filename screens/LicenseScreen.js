...
import { Appearance, useColorScheme, View, SafeAreaView, ScrollView, StyleSheet } from 'react-native'
...
const LicenseScreen = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={[styles.container, themeContainerStyle]}>
            ...
            <Button title="Я согласен с правилами" titleStyle={{fontFamily: 'Inter_700Bold',fontSize: 14,color: '#F2F2F3',}} containerStyle={styles.btn} buttonStyle={styles.innertBtn} onPress={() => navigation.navigate('login')} />
        </SafeAreaView>
    )
}
